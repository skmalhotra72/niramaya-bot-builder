	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Brand colors for NirAmaya
				'brand-teal': 'hsl(var(--brand-teal))',
				'brand-teal-light': 'hsl(var(--brand-teal-light))',
				'brand-teal-lighter': 'hsl(var(--brand-teal-lighter))',
				'brand-saffron': 'hsl(var(--brand-saffron))',
				'brand-saffron-light': 'hsl(var(--brand-saffron-light))',
